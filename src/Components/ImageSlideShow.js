...
const ImageSlideShow = ({ images }) => {
	...
	return (
		...
		<div id="image-slide-show" className="uk-position-relative uk-visible-toggle uk-light cursor-pointer uk-height-1-1" tabIndex="-1" data-uk-slideshow uk-data-type="image">
